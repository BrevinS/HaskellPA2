...
exprtree3 = (ENODE Pow (ENODE Add 
                              (ENODE Sub (ENODE Sub (ELEAF 20) (ENODE Pow (ELEAF 4) (ELEAF 2))) (ENODE Pow (ELEAF 3) (ELEAF 1))) 
                                   (ENODE Sub (ELEAF 6000) (ELEAF 5998))) 
                                        (ENODE Sub (ELEAF 10) (ELEAF 8)))
exprtree4 = (ENODE Add (ENODE Pow 
                              (ENODE Pow (ENODE Sub (ENODE Add (ELEAF 5) (ENODE Pow (ELEAF 6) (ENODE Add (ELEAF 2) (ELEAF 2)))) (ENODE Mul (ELEAF 1200) (ELEAF 1))) (ENODE Mul (ELEAF 1) (ENODE Sub (ELEAF 6) (ELEAF 2)))) 
                                   (ENODE Pow (ELEAF 6000) (ELEAF 0))) 
                                        (ENODE Pow (ENODE Add (ENODE Sub (ENODE Sub (ELEAF 20) (ENODE Pow (ELEAF 4) (ELEAF 2))) (ENODE Pow (ELEAF 3) (ELEAF 1))) 
                                   (ENODE Sub (ELEAF 12000) (ELEAF 11998))) 
                                        (ENODE Sub (ELEAF 10) (ELEAF 8))))
...
p4a_test4 = TestCase (assertEqual "evaluateTree exprtree3" 9 (evaluateTree exprtree3) )
p4a_test5 = TestCase (assertEqual "evaluateTree exprtree4" 104060410 (evaluateTree exprtree4) )
...
p4b_test4 = TestCase (assertEqual "printInfix exprtree3" "((((20 `Sub` (4 `Pow` 2)) `Sub` (3 `Pow` 1)) `Add` (6000 `Sub` 5998)) `Pow` (10 `Sub` 8))" (printInfix  exprtree3) )
p4b_test5 = TestCase (assertEqual "printInfix exprtree4" "(((((5 `Add` (6 `Pow` (2 `Add` 2))) `Sub` (1200 `Mul` 1)) `Pow` (1 `Mul` (6 `Sub` 2))) `Pow` (6000 `Pow` 0)) `Add` ((((20 `Sub` (4 `Pow` 2)) `Sub` (3 `Pow` 1)) `Add` (12000 `Sub` 11998)) `Pow` (10 `Sub` 8)))" (printInfix  exprtree4) )
...
tests = TestList [ TestLabel "Problem 1a - test1 " p1a_test1,
                   ...
                   TestLabel "Problem 4b - test4 " p4a_test4,
                   TestLabel "Problem 4b - test5 " p4a_test5
